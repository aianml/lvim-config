-- get started with jdtls
local status, jdtls = pcall(require, "jdtls")
if not status then
  return
end

-- location for data about our java projects
...
-- put it all together
-- NOTE: the runtimes indicate supported java versions
lvim.builtin.dap.active = true
local config = {
  cmd = {
    "java",
    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          ...
          {
            name = "JavaSE-17",
            path = "~/.sdkman/candidates/java/17.0.7-ms",
          }
        },
      },
      maven = {
